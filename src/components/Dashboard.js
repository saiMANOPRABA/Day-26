                        ...
                        <div className="row no-gutters align-items-center">
                            <div className="col mr-2">
                                <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Earnings (Annual)</div>
                                <div className="h5 mb-0 font-weight-bold text-gray-800">{props.data.data.anual}</div>
                            </div>
                            <div className="col-auto">
                                    ...
                                    <div className="col">
                                        <div className="progress progress-sm mr-2">
                                            <div className="progress-bar bg-info" role="progressbar"
                                                style={{width: props.data.data.task}} aria-valuenow="50" aria-valuemin="0"
      ...
      <tbody>
        {
            props.data.students.map((e,i)=>{
                return <tr key={i}>
                    ...
                    <td>{e.batch}</td>
                    <td>
                        <Button variant="outline-primary" onClick={()=>navigate(`/editstudent/${i}`)}>Edit</Button>
                        &nbsp; &nbsp;
                        <Button variant="outline-danger" onClick = {()=>handleDelete(i)}>Delete</Button>
                    </td>
                </tr>
            })
        }
